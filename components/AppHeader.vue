...
<style scoped>
.header { height: 76px; display: grid; grid-template-columns: 1fr auto; align-items: center; max-width: 1180px; margin: auto; padding: 0 28px; }
...
@media (max-width: 640px) { .header { padding: 0 18px; } }
</style>
