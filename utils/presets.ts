...
export const workflowPresets: Record<Workflow, Preset[]> = {
  'video-compress': [
    ...
    { id: 'balanced', title: 'Make sharing easier', description: 'A useful size reduction while keeping a clear, detailed picture.', icon: 'fluent:send-24-regular', summary: ['Up to 1080p', 'Good quality', '192 kbps audio'], values: { format: 'mp4', videoCodec: 'libx264', quality: 24, resolution: '1920:1080:force_original_aspect_ratio=decrease:force_divisible_by=2', frameRate: 0, audioCodec: 'aac', audioBitrate: 192 } },
