...
export const workflowPresets: Record<Workflow, Preset[]> = {
  'video-compress': [
    ...
    { id: 'balanced', title: 'Make sharing easier', description: 'A noticeably smaller file with good everyday quality.', icon: 'fluent:send-24-regular', summary: ['Up to 720p', 'Balanced quality', '128 kbps audio'], values: { format: 'mp4', videoCodec: 'libx264', quality: 28, resolution: '1280:720:force_original_aspect_ratio=decrease:force_divisible_by=2', frameRate: 30, audioCodec: 'aac', audioBitrate: 128 } },
    { id: 'smallest', title: 'Save the most space', description: 'Prioritizes a small file for storage and slow connections.', icon: 'fluent:archive-24-regular', summary: ['Up to 480p', 'Smallest file', '64 kbps audio'], values: { format: 'mp4', videoCodec: 'libx264', quality: 34, resolution: '854:480:force_original_aspect_ratio=decrease:force_divisible_by=2', frameRate: 24, audioCodec: 'aac', audioBitrate: 64 } }
  ],
  'video-convert': [
    ...
    { id: 'convert-smaller', title: 'Convert and make it smaller', description: 'Change format and deliberately reduce the size for easier sharing.', icon: 'fluent:arrow-download-24-regular', summary: ['Up to 720p', 'Smaller file', '128 kbps audio'], values: { format: 'mp4', videoCodec: 'libx264', quality: 27, resolution: '1280:720:force_original_aspect_ratio=decrease:force_divisible_by=2', frameRate: 30, audioCodec: 'aac', audioBitrate: 128 } }
  ],
  'video-audio': [
